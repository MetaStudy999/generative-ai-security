...
| 저자 | Apostolos Voulodimos et al. |
| 학술지/학회 | Computational Intelligence and Neuroscience |
| 연도 | 2018 |
| DOI/URL | 확인 필요 |
...
P02는 컴퓨터비전 표현학습 및 비전 대적공격 연구에서 개념 정의, 위협 분류, 평가 지표 후보를 정리하는 근거로 반영한다. 특히 기말 연구의 배경 이론과 평가축을 관련연구와 연구방법 장에 연결한다.
