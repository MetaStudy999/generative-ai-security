...
|---|---|---|---|
| P01 | A Critical Review on the Use (and Misuse) of Differential Privacy in Machine Learning | DP misuse와 reporting 책임 | arXiv 확인, ACM DOI 공식 확인 필요 |
| P02 | Recent Advances of Differential Privacy in Centralized Deep Learning | DP-DL auditing과 privacy-utility 개선 | arXiv 확인, ACM 최종본 대조 필요 |
| P03 | Differential Privacy in Deep Learning: A Literature Survey | DP 적용 위치와 보호 대상 | DOI 후보 확인, 로컬 PDF 대체 |
| P04 | Membership Inference Attacks on Machine Learning | MI attack taxonomy | arXiv 확인, ACM DOI 공식 확인 필요 |
| P05 | Defenses to Membership Inference Attacks | defense taxonomy와 trade-off | DOI 후보 확인, 로컬 PDF 대체 |
...
| P03/P05는 왜 대체 PDF인가? | 로컬 파일명이 `SUBSTITUTE`이고 첫 페이지가 지정 논문과 다르다. | `01_papers/doi_check.md` |
