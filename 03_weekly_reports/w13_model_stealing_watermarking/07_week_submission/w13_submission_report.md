...
| P05 | 지정 후보 Chenhan Zhang et al. / 로컬 Cai et al. | DOI `10.1145/3615336` 후보 확인, 로컬 관련 보조 문헌 원문 | 생성모형 보조 배경 |
...
3. P02/P05처럼 관련 보조 문헌 원문이 있을 때 최종 참고문헌 검증표에는 무엇을 남겨야 하는가?
...
| [5] | Zhang et al., Generative Adversarial Networks: A Survey on Attack and Defense Perspective / 로컬 Cai et al. 관련 보조 문헌 | `10.1145/3615336` 후보 확인 | 로컬 PDF 표기 차이 |
