...
W15 감사는 개인정보를 사용하지 않았고 실제 공격을 수행하지 않았다. 결과는 산출물 존재 여부와 검증 상태만 나타내며, LLM 또는 XAI 모델의 성능을 주장하지 않는다. 참고문헌 검증은 P01, P02, P04, P05는 확인, P03은 관련 논문 PDF로 인한 부분 확인 상태다.
