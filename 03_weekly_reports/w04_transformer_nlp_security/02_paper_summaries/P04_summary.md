...
| 항목 | 내용 |
|---|---|
| 논문 제목 | A Survey of Adversarial Defences and Robustness in NLP |
| 저자 | Shreya Goyal et al. |
| 학술지/학회 | arXiv; ACM Computing Surveys accepted 표기 |
| 연도 | 2023 |
| DOI/URL | `10.48550/arXiv.2203.06414`, https://arxiv.org/abs/2203.06414 |
| PDF 파일명 | 04_Goyal_et_al_2023_Adversarial_Defences_Robustness_NLP.pdf |
| 검증 상태 | arXiv DOI/URL 확인, 출판사 DOI는 미확인 |
...
P04는 Transformer 변형 및 NLP 대적공격/프라이버시 연구에서 개념 정의, 위협 분류, 평가 지표 후보를 정리하는 근거로 반영한다. 특히 기말 연구의 배경 이론과 평가축을 관련연구와 연구방법 장에 연결한다.
