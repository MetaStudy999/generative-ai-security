...
| P04 | 대적 공격과 방어를 어떻게 분류하고 검증할 것인가 | attack/defense taxonomy, 방어 한계 분석 | survey 및 문헌 기반 비교 | evasion, physical attack, gradient masking, transfer attack | attack success rate, robust accuracy, clean accuracy | arXiv 기준, 특정 방어 효과는 실험 필요 | adversarial robustness 장 |
