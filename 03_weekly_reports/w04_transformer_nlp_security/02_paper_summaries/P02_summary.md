...
| 저자 | Quentin Fournier et al. |
| 학술지/학회 | ACM Computing Surveys |
| 연도 | 2023 |
| DOI/URL | `10.1145/3586074`, https://arxiv.org/abs/2103.14636 |
| PDF 파일명 | 02_Fournier_et_al_2023_Faster_Lighter_Transformers_Survey.pdf |
| 검증 상태 | ACM 출판 DOI 및 arXiv URL 확인 |
...
P02는 Transformer 변형 및 NLP 대적공격/프라이버시 연구에서 개념 정의, 위협 분류, 평가 지표 후보를 정리하는 근거로 반영한다. 특히 기말 연구의 배경 이론과 평가축을 관련연구와 연구방법 장에 연결한다.
