...
- 강의계획서상 주제: 자기지도학습·파운데이션 모델 & Poisoning/Backdoor
...
|---|---|---|---:|---|---|---|---|---|
| P01 | A Survey on Self-Supervised Learning: Algorithms, Applications, and Future Trends | Jie Gui et al. | 2024 | IEEE TPAMI | https://doi.org/10.1109/TPAMI.2024.3415112 | `01_papers/paper_list.md`, `01_papers/doi_check.md` | 검증 기록 기반 | 확인 완료(로컬/공식 검증 기록 기준) |
| P02 | A Comprehensive Survey on Self-Supervised Learning for Recommendation | Xubin Ren, Wei Wei, Lianghao Xia, Chao Huang | 2025 | ACM Computing Surveys | https://doi.org/10.1145/3746280 | `01_papers/paper_list.md`, `01_papers/doi_check.md` | 검증 기록 기반 | 확인 완료(로컬/공식 검증 기록 기준) |
| P03 | 확인 필요 | Madeline C. Schiappa, Yogesh S. Rawat, Mubarak Shah | 확인 필요 | 확인 필요 | 10.1145/3577925; arXiv 2207.00419 | `01_papers/paper_list.md`, `01_papers/doi_check.md` | 검증 기록 기반 | 확인 완료(로컬/공식 검증 기록 기준) |
| P04 | Threats to Training: A Survey of Poisoning Attacks and Defenses on Machine Learning Systems | Zhibo Wang et al. | 2022 | ACM Computing Surveys | https://doi.org/10.1145/3538707 | `01_papers/paper_list.md`, `01_papers/doi_check.md` | 검증 기록 기반 | 확인 완료(로컬/공식 검증 기록 기준) |
| P05 | A survey of backdoor attacks and defences: From deep neural networks to large language models | Ling-Xin Jin et al. | 2025 | Journal of Electronic Science and Technology | https://doi.org/10.1016/j.jnlest.2025.100326 | `01_papers/paper_list.md`, `01_papers/doi_check.md` | 검증 기록 기반 | 확인 완료(로컬/공식 검증 기록 기준) |
...
- [w05_submission_report.html](07_week_submission/w05_submission_report.html)
- [w05_submission_report.md](07_week_submission/w05_submission_report.md)
...
- config.yaml 상태: `executed_toy_experiment` (executed 상태와 outputs 일치)
- outputs 폴더 존재 여부: O
...
- 그래프 파일 존재 여부: O
- 수치 대조 상태: 기준 원천 존재
- 수치 기준 원천: `03_weekly_reports/w05_ssl_backdoor/04_experiment/outputs/metrics_summary.csv`

## 5. 기말논문 연결

1. 이 주차에서 기말논문에 반영할 개념: 자기지도학습·파운데이션 모델 & Poisoning/Backdoor의 핵심 개념을 LLM/RAG 시스템 생명주기별 위협·통제 항목으로 반영한다.
