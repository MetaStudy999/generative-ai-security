...
| 저자 | Yi Tay et al. |
| 학술지/학회 | arXiv 2022 edition; ACM CSUR 여부 미확인 |
| 연도 | 2022 |
| DOI/URL | `10.48550/arXiv.2009.06732`, https://arxiv.org/abs/2009.06732 |
...
P01는 Transformer 변형 및 NLP 대적공격/프라이버시 연구에서 개념 정의, 위협 분류, 평가 지표 후보를 정리하는 근거로 반영한다. 특히 기말 연구의 배경 이론과 평가축을 관련연구와 연구방법 장에 연결한다.
