...
| 항목 | 내용 |
|---|---|
| 대상 시스템 | 연합학습(FL) 및 FL 위협/방어/정책를 사용하는 ML/AI 시스템 |
...
| 공격자의 능력 | Gradient leakage, Membership inference in FL, Poisoning attack, Model poisoning, Backdoor attack in FL |
...
RQ1. 연합학습(FL) 및 FL 위협/방어/정책 생명주기에서 가장 우선적으로 보증해야 할 자산은 무엇인가?

RQ2. Gradient leakage, Membership inference in FL는 어느 단계에서 발생하며 어떤 지표로 측정할 수 있는가?
