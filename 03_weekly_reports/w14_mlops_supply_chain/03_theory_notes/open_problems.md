...
MLOps/DevOps/데이터/모델 파이프라인/공급망 보안는 MLOps의 기본 개념, DevOps와 MLOps의 차이, ML lifecycle와 ML supply chain risk, 데이터 파이프라인 오염, 모델 아티팩트 변조가 동시에 얽힌다. 단일 지표만으로 성능과 보안성을 판단하면 연구 결론이 과도하게 단순화될 수 있다.
