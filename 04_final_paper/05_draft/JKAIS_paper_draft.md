...
데이터셋은 [04_final_paper/04_methodology_experiment/data/rag_security_dataset_100.csv](../04_methodology_experiment/data/rag_security_dataset_100.csv)에 저장했다. 모든 문서는 synthetic이며 실제 개인정보, 실제 계정, 실제 API 키, 실제 기업명은 포함하지 않는다.
...
실험은 Python 3.12.3에서 실행했다. 실행 파일은 [04_final_paper/04_methodology_experiment/scripts/](../04_methodology_experiment/scripts/)에 있으며 결과는 [04_final_paper/04_methodology_experiment/outputs/](../04_methodology_experiment/outputs/)에 저장했다.
...
실패 사례 전체는 [04_final_paper/04_methodology_experiment/outputs/failure_cases.md](../04_methodology_experiment/outputs/failure_cases.md)에 기록했다. Baseline 실패는 대부분 위험 문서를 allow 처리한 false negative였다.
