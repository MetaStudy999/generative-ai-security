...
| P04 | Antonio Cina et al., "Training Data Poisoning Attacks and Defenses: A Systematic Review" | "Wild Patterns Reloaded: A Survey of Machine Learning Security against Training Data Poisoning" | 동일 저자군/주제의 ACM CSUR 논문은 확인됐으나, 강의계획서 지정 제목과 완전 동일한 제목의 출판판은 확인하지 못함. 현재 P04는 대체/판본 추가 확인 메모 문헌으로 표시 |
