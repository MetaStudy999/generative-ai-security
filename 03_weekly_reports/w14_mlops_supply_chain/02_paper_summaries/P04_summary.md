...
| 항목 | 내용 |
|---|---|
| 논문 제목 | Deep Learning with Edge Computing: A Review |
| 저자 | J. Chen et al. |
| 학술지/학회 | Proceedings of the IEEE |
| 연도 | 2019 |
| DOI/URL | 확인 필요 |
| PDF 파일명 | 04_SUBSTITUTE_Zhou_et_al_2019_Edge_Intelligence_Survey.pdf |
...
P04는 MLOps/DevOps/데이터/모델 파이프라인/공급망 보안 연구에서 개념 정의, 위협 분류, 평가 지표 후보를 정리하는 근거로 반영한다. 특히 기말 연구의 배경 이론과 평가축을 관련연구와 연구방법 장에 연결한다.
