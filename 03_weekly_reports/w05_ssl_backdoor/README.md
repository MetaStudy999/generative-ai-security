...
|---|---|---|---:|---|---|---|---|---|
| P01 | A Survey on Self-Supervised Learning: Algorithms, Applications, and Future Trends | Jie Gui et al. | 2024 | IEEE TPAMI | https://doi.org/10.1109/TPAMI.2024.3415112 | `01_papers/paper_list.md`, `01_papers/doi_check.md` | 현 세션 인터넷 미확인 | 확인 완료(로컬 검증 기록 기준, 현 세션 인터넷 재확인 없음) |
| P02 | A Comprehensive Survey on Self-Supervised Learning for Recommendation | Xubin Ren, Wei Wei, Lianghao Xia, Chao Huang | 2025 | ACM Computing Surveys | https://doi.org/10.1145/3746280 | `01_papers/paper_list.md`, `01_papers/doi_check.md` | 현 세션 인터넷 미확인 | 확인 완료(로컬 검증 기록 기준, 현 세션 인터넷 재확인 없음) |
| P03 | 확인 필요 | Madeline C. Schiappa, Yogesh S. Rawat, Mubarak Shah | 확인 필요 | 확인 필요 | 10.1145/3577925; arXiv 2207.00419 | `01_papers/paper_list.md`, `01_papers/doi_check.md` | 현 세션 인터넷 미확인 | 확인 완료(로컬 검증 기록 기준, 현 세션 인터넷 재확인 없음) |
| P04 | Threats to Training: A Survey of Poisoning Attacks and Defenses on Machine Learning Systems | Zhibo Wang et al. | 2022 | ACM Computing Surveys | https://doi.org/10.1145/3538707 | `01_papers/paper_list.md`, `01_papers/doi_check.md` | 현 세션 인터넷 미확인 | 확인 완료(로컬 검증 기록 기준, 현 세션 인터넷 재확인 없음) |
| P05 | A survey of backdoor attacks and defences: From deep neural networks to large language models | Ling-Xin Jin et al. | 2025 | Journal of Electronic Science and Technology | https://doi.org/10.1016/j.jnlest.2025.100326 | `01_papers/paper_list.md`, `01_papers/doi_check.md` | 현 세션 인터넷 미확인 | 확인 완료(로컬 검증 기록 기준, 현 세션 인터넷 재확인 없음) |
