...
P01~P05는 강의계획서 지정 표기, 공식 DOI 메타데이터, 로컬 PDF 사이에 여러 불일치가 있다. P01은 제목과 DOI 후보는 맞지만 매체 정보가 강의 표기와 다르고, P02는 Sen/Shuai Zhou 및 로컬 Kui Ren PDF 차이가 남아 있다. P03은 공식 published title과 강의 표기 제목이 다르다. P04와 P05는 유사 DOI 후보가 있으나 지정 저자·제목·연도와 일치하지 않아 확정하지 않았다.
...
4. 공식 DOI와 로컬 PDF가 불일치하는 상태에서 연구윤리적으로 어떤 인용 정책을 적용해야 하는가?
