...
| 항목 | 내용 |
|---|---|
| 논문 제목 | Deep Learning for Software Engineering: A Survey |
| 저자 | Xiang Chen et al. |
| 학술지/학회 | ACM Computing Surveys |
| 연도 | 2022 |
| DOI/URL | 확인 필요 |
| PDF 파일명 | 05_Yang_Xia_Lo_Grundy_2022_Deep_Learning_Software_Engineering.pdf |
...
P05는 MLOps/DevOps/데이터/모델 파이프라인/공급망 보안 연구에서 개념 정의, 위협 분류, 평가 지표 후보를 정리하는 근거로 반영한다. 특히 기말 연구의 배경 이론과 평가축을 관련연구와 연구방법 장에 연결한다.
