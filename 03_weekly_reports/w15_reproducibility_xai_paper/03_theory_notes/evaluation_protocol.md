...
|---|---|---|---|---|
| Evaluation Reliability | Reliability score | 벤치마크 중복·오염·관련 논문 PDF 여부 확인 | Benchmark metadata, paper list | 평가 신뢰성 |
...
| Limitation Clarity | Limitation coverage | 관련 논문 PDF, 미검증 DOI, 실행 전 결과, 제외 범위 명시 여부 | Paper draft, self review | 연구 신뢰성 |
