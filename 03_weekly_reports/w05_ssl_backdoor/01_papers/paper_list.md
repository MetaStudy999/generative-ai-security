...
|---|---|---|---|---|---|---|
| P01 | Yan Gui et al., "Self-Supervised Learning: Algorithms, Applications, and Future Trends", IEEE TPAMI, 2024 | A Survey on Self-Supervised Learning: Algorithms, Applications, and Future Trends | Jie Gui, Tuo Chen, Jing Zhang, Qiong Cao, Zhenan Sun, Hao Luo, Dacheng Tao | IEEE Transactions on Pattern Analysis and Machine Intelligence, 46(12), 9052-9071, 2024 | `10.1109/TPAMI.2024.3415112`; arXiv `10.48550/arXiv.2301.05712` | TPAMI DOI 확인. 100점형 summary 보완 완료. 강의계획서의 `Yan Gui`는 `Jie Gui` 표기 오기 가능성이 있어 사람 최종 추가 확인 메모 |
| P02 | H. Ren et al., "A Comprehensive Survey on Self-Supervised Learning", ACM Computing Surveys, 2025 | A Comprehensive Survey on Self-Supervised Learning for Recommendation | Xubin Ren, Wei Wei, Lianghao Xia, Chao Huang | ACM Computing Surveys, 58(1), Article 22, 1-38, online 2025 | `10.1145/3746280` | 100점형 summary 보완 완료. 로컬 PDF는 추천 시스템 SSL survey다. 강의계획서 지정 일반 SSL survey와 동일 여부 추가 확인 메모 |
| P03 | "Self-Supervised Learning of Video Representations: A Survey" | Self-Supervised Learning for Videos: A Survey | Madeline C. Schiappa, Yogesh S. Rawat, Mubarak Shah | ACM Computing Surveys, 55(13s), 1-37, 2023 | `10.1145/3577925`; arXiv `2207.00419` | ACM 정식 제목 확인. 100점형 summary 보완 완료. 강의계획서 제목은 의미상 축약/변형 가능성이 있으나 제목 차이 기록 |
| P04 | Y. Wang et al., "A Survey of Poisoning Attacks and Defenses on Machine Learning", ACM Computing Surveys, 2022 | Threats to Training: A Survey of Poisoning Attacks and Defenses on Machine Learning Systems | Zhibo Wang, Jingjing Ma, Xue Wang, Jiahui Hu, Zhan Qin, Kui Ren | ACM Computing Surveys, 55(7), Article 134, 1-36, 2022 | `10.1145/3538707` | 100점형 summary 보완 완료. 로컬 PDF 정식 제목/저자 확인. 강의계획서 제목 및 `Y. Wang` 표기와 동일 논문 여부 추가 확인 메모 |
| P05 | Z. Jin et al., "A survey of backdoor attacks and defences: From deep neural networks to large language models", Journal of Electronic Science and Technology, 2025 | A survey of backdoor attacks and defences: From deep neural networks to large language models | Ling-Xin Jin, Wei Jiang, Xiang-Yu Wen, Mei-Yu Lin, Jin-Yu Zhan, Xing-Zhi Zhou, Maregu Assefa Habtie, Naoufel Werghi | Journal of Electronic Science and Technology, 23(3), Article 100326, 2025 | `10.1016/j.jnlest.2025.100326` | DOI/저자/학술지 확인. 100점형 summary 보완 완료. 강의계획서 `Z. Jin` 표기는 출판사 기준 첫 저자명과 다르므로 추가 확인 메모 |

## 2. 100점형 summary 반영 상태

| ID | 보완 상태 | 추가된 핵심 요소 |
|---|---|---|
| P01 | 완료 | InfoNCE, masked reconstruction, linear probe, SSL corpus/augmentation 위협모형, representation shift |
| P02 | 완료 / 검증 필요 | 추천 SSL, masked reconstruction, user-item contrastive loss, fake interaction/graph poisoning, ranking utility |
| P03 | 완료 | temporal contrastive objective, temporal consistency loss, video SSL threat model, temporal trigger |
| P04 | 완료 / 검증 필요 | poisoned training objective, poison rate, detection rate/FPR, data/model poisoning taxonomy |
| P05 | 완료 | backdoor trigger function, backdoor objective, ASR, utility drop, ASRDrop, DNN-to-LLM hidden behavior |
...
| P02 | 관련 논문 / 확인 | A Comprehensive Survey on Self-Supervised Learning for Recommendation | A Comprehensive Survey on Self-Supervised Learning for Recommendation | Xubin Ren, Wei Wei, Lianghao Xia, Chao Huang | 2025 | ACM Computing Surveys | ACM Computing Surveys | `https://doi.org/10.1145/3746280` | 공식 DOI 확인. 강의계획서 지정 일반 SSL survey와 동일 여부 확인 필요 | 주차 주제 보강용 관련 논문으로 인용 |
| P03 | 논문 / 확인 | Self-Supervised Learning for Videos: A Survey | Self-Supervised Learning for Videos: A Survey | Madeline C. Schiappa, Yogesh S. Rawat, Mubarak Shah | 2023 | ACM Computing Surveys | ACM Computing Surveys | `https://doi.org/10.1145/3577925` | 공식 DOI 확인 | 공식 서지 기준으로 논문 인용 |
| P04 | 관련 논문 / 확인 | Threats to Training: A Survey of Poisoning Attacks and Defenses on Machine Learning Systems | Threats to Training: A Survey of Poisoning Attacks and Defenses on Machine Learning Systems | Zhibo Wang et al. | 2022 | ACM Computing Surveys | ACM Computing Surveys | `https://doi.org/10.1145/3538707` | 공식 DOI 확인. 강의계획서 표기와 동일 여부 확인 필요 | 주차 주제 보강용 관련 논문으로 인용 |
