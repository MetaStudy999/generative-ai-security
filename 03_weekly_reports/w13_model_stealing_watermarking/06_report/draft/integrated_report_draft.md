# W13 모델 지식재산(IP)·모델 도난·모델 추출 위협 통합보고서 초안

본 초안은 최종본과 같은 구조를 사용한다. 최종 제출 기준 문서는 `../final/integrated_report_final.md`이며, 실험 수치는 `../../04_experiment/outputs/run_log.md`와 일치한다.
