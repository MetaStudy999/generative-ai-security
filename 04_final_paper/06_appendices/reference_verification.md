...
| 11 | 해외 | Concept-based Explainable Artificial Intelligence: A Survey | 로컬 PDF, arXiv `2312.12936` | 부분 확인 | 4.4 평가방법, 6.5 안전성 | □ |
| 12 | 해외 | Explainable AI: Core Ideas, Techniques, and Solutions | 지정 논문 원문 확보 필요 | 미검증 | 2.2 해외 연구 후보 | □ |

## 검증 원칙

- 최종 참고문헌에는 검증 상태가 `확인`인 문헌을 우선 반영한다.
- `부분 확인` 문헌은 DOI/권호/출판사 페이지를 추가 확인한 뒤 확정한다.
