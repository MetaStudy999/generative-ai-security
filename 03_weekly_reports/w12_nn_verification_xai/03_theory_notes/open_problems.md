...
신경망 검증/정형방법 및 대적방어/XAI/강건성 트레이드오프는 신경망 검증의 기본 개념, 정형검증과 경험적 평가의 차이, Abstraction method와 대적공격과 대적방어, Certified robustness, Empirical robustness와 formal robustness의 차이가 동시에 얽힌다. 단일 지표만으로 성능과 보안성을 판단하면 연구 결론이 과도하게 단순화될 수 있다.
