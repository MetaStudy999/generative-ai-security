...
| 주요 프롬프트 요약 | W13 제출 보고서 보완, 참고문헌 검증 상태 정리, `metrics_summary.csv` 기반 그래프 생성, HTML 재생성 |
| AI 산출물 반영 위치 | `07_week_submission/w13_submission_report.md`, `07_week_submission/w13_submission_report.html`, `07_week_submission/assets/w13_metric_chart.png` |
