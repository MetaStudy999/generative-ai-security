...
| ID | 역할 |
|---|---|
| P01 | Abstraction 기반 신경망 검증의 배경 |
| P02 | 대적공격과 방어의 taxonomy |
| P03 | XAI 설명 결과가 공격면이 될 수 있다는 근거 |
| P04 | Lipschitz regularization과 robustness certificate 연결 |
| P05 | Robustness, accuracy, fairness trade-off 정리 |
...
| 조건 | Clean Accuracy | Robust Accuracy | Explanation Stability | Certified Rate |
|---|---:|---:|---:|---:|
...
이 결과는 synthetic toy classification에서 얻은 교육용 수치다. Certified rate는 대규모 DNN 검증 결과가 아니라 선형 모델의 bound proxy다.
