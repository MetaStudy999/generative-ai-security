...
| P03 | `pdf/03_SUBSTITUTE_Fu_et_al_2024_Differentially_Private_FL_Review.pdf` | 대체 PDF arXiv `2405.08299`; 지정 논문 DOI `10.1016/j.neucom.2024.127663` | 대체 PDF | 지정 논문은 Neurocomputing `Differential privacy in deep learning: A literature survey`; 로컬 PDF와 불일치 |
...
| P05 | `pdf/05_SUBSTITUTE_Bai_et_al_2024_MIA_Attacks_Defenses_FL_Survey.pdf` | 대체 PDF arXiv `2412.06157`; 지정 논문 DOI `10.1145/3620667` | 대체 PDF | 지정 논문은 ACM CSUR `Defenses to Membership Inference Attacks: A Survey`; 로컬 PDF와 불일치 |
