...
|---|---:|---:|---:|---:|---:|---|
| Clean baseline | 0% | 0 | 0.981481 | 0.981443 | 해당 없음 | 기준 모델 |
| Label-flip | 5% | 63 | 0.918519 | 0.918457 | 해당 없음 | 약한 오염 |
| Label-flip | 10% | 126 | 0.877778 | 0.877582 | 해당 없음 | 중간 오염 |
| Label-flip | 20% | 251 | 0.818519 | 0.818134 | 해당 없음 | 강한 오염 |
| Safe toy backdoor | 5% | 63 | 0.970370 | 0.970359 | 0.987654 | clean 성능과 ASR 동시 확인 |
...
6. 발표자료와 제출용 보고서의 수치가 다를 경우 `outputs/metrics_summary.csv`를 기준으로 수정한다.
