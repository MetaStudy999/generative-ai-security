...
MLOps supply-chain map 기준으로 공격자, 방어자, 보호 자산, 성공 조건을 분리한다.

## Main Figure

- Diagram: `assets/diagrams/w14_pipeline_diagram.svg`
- Chart: `assets/charts/w14_metrics_chart.svg`
...
hash/pass 항목은 시각화에서 제외했으며 원본 CSV와 artifact inventory를 함께 확인해야 한다. toy/synthetic 범위와 formal guarantee 여부를 구분해야 한다.
