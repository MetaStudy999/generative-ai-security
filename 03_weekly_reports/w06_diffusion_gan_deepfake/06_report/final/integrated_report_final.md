...
|---|---|---|---|
| P01 | $q(x_t\mid x_{t-1})=\mathcal N(\sqrt{1-\beta_t}x_{t-1},\beta_t I)$, $L=\lVert\epsilon-\epsilon_\theta(x_t,t)\rVert^2$ | diffusion은 이미지에 노이즈를 조금씩 섞고, 모델은 그 노이즈를 거꾸로 제거하는 법을 배운다. | 생성모형 원리 |
