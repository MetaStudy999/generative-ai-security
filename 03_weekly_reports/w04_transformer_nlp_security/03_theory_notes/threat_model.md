...
| 항목 | 내용 |
|---|---|
| 대상 시스템 | Transformer 변형 및 NLP 대적공격/프라이버시를 사용하는 ML/AI 시스템 |
...
| 공격자의 능력 | NLP 대적공격, 단어 치환 공격, 문장 재구성 공격, 의미 보존 공격, Prompt privacy |
...
RQ1. Transformer 변형 및 NLP 대적공격/프라이버시 생명주기에서 가장 우선적으로 보증해야 할 자산은 무엇인가?

RQ2. NLP 대적공격, 단어 치환 공격는 어느 단계에서 발생하며 어떤 지표로 측정할 수 있는가?
