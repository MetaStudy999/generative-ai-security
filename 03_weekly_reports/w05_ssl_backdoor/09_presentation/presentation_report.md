...
|---|---|---|---|
| P01 | A Survey on Self-Supervised Learning: Algorithms, Applications, and Future Trends | SSL 알고리즘과 응용 taxonomy | TPAMI DOI 확인, 강의계획서 저자 표기 확인 필요 |
| P02 | A Comprehensive Survey on Self-Supervised Learning for Recommendation | SSL recommendation survey와 contrastive/generative/adversarial 분류 | DOI 확인, 지정 일반 SSL survey 동일 여부 확인 필요 |
| P03 | Self-Supervised Learning for Videos: A Survey | video SSL과 temporal/cross-modal representation | DOI 확인, arXiv URL 확인, Article 번호 확인 필요 |
| P04 | Threats to Training: A Survey of Poisoning Attacks and Defenses on Machine Learning Systems | poisoning 공격·방어 taxonomy | DOI 확인, 강의계획서 제목/저자 표기 확인 필요 |
| P05 | A survey of backdoor attacks and defences | DNN부터 LLM까지 backdoor 분류 | DOI 확인, 강의계획서 저자 표기 확인 필요 |
...
| DOI는 모두 확정인가? | P01 TPAMI DOI와 P02-P05 DOI는 확인했지만, P02 지정 문헌 동일 여부와 P03/P04/P05 표기 차이는 확인 필요로 남겼다. | `01_papers/doi_check.md` |
