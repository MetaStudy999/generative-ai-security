...
| 항목 | 내용 |
|---|---|
| 대상 시스템 | 컴퓨터비전 표현학습 및 비전 대적공격를 사용하는 ML/AI 시스템 |
...
| 공격자의 능력 | 비전 기반 대적공격, White-box attack, Black-box attack, Transfer attack, FGSM, PGD 등 기본 공격 개념 |
...
RQ1. 컴퓨터비전 표현학습 및 비전 대적공격 생명주기에서 가장 우선적으로 보증해야 할 자산은 무엇인가?

RQ2. 비전 기반 대적공격, White-box attack는 어느 단계에서 발생하며 어떤 지표로 측정할 수 있는가?
