...
| 항목 | 내용 |
|---|---|
| 대상 시스템 | 자기지도학습/파운데이션 모델 및 Poisoning/Backdoor를 사용하는 ML/AI 시스템 |
...
| 공격자의 능력 | Self-supervised pretraining 단계의 공격면, 데이터 오염과 표현공간 왜곡, Poisoning attack, Backdoor attack, Trigger injection |
...
RQ1. 자기지도학습/파운데이션 모델 및 Poisoning/Backdoor 생명주기에서 가장 우선적으로 보증해야 할 자산은 무엇인가?

RQ2. Self-supervised pretraining 단계의 공격면, 데이터 오염과 표현공간 왜곡는 어느 단계에서 발생하며 어떤 지표로 측정할 수 있는가?
