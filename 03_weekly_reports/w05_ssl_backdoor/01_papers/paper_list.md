...
| P02 | H. Ren et al., "A Comprehensive Survey on Self-Supervised Learning", ACM Computing Surveys, 2025 | A Comprehensive Survey on Self-Supervised Learning for Recommendation | Xubin Ren, Wei Wei, Lianghao Xia, Chao Huang | ACM Computing Surveys, 58(1), Article 22, 1-38, online 2025 | `10.1145/3746280` | 로컬 PDF는 추천 시스템 SSL survey다. 강의계획서 지정 일반 SSL survey와 동일 여부 추가 확인 메모 |
