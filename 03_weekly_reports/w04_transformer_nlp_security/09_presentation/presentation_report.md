...
|---|---|---|---|
| P01 | Efficient Transformers: A Survey | X-former와 efficient attention 분류 | ACM DOI `10.1145/3530811` 확인 |
...
| P04 | A Survey of Adversarial Defenses and Robustness in NLP | NLP 대적공격 방어 taxonomy | ACM DOI `10.1145/3593042` 확인, 강의자료 표기 확인 필요 |
| P05 | Privacy Preserving Prompt Engineering: A Survey | prompt privacy와 ICL 보호 방법 | ACM DOI `10.1145/3729219` 확인 |
...
| DOI는 모두 확정인가? | P01/P02/P04/P05는 ACM DOI를 확인했고 P03은 AI Open DOI를 확인했다. 다만 ACM Article 번호와 P04 강의자료 저자 표기는 사람 검토가 필요하다. | `01_papers/doi_check.md` |
