...
| 입력 근거 | `w09_drl_cybersecurity/04_experiment/outputs/metrics_summary.csv`, 기존 통합보고서, 발표 슬라이드, 이론노트 |
| 생성 산출물 | `09_presentation/assets/charts/w09_metrics_chart.png`, `09_presentation/assets/charts/w09_metrics_chart.svg`, `09_presentation/assets/diagrams/w09_pipeline_diagram.svg`, `09_presentation/assets/figure_manifest.md` |
