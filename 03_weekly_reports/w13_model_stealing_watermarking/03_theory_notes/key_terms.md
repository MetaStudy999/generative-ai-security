...
| Query-response pair | 입력과 victim model 출력으로 구성된 query-response training record | 실제 API가 아닌 synthetic pair만 사용 |
...
| 관련 논문 PDF | 프롬프트 지정 문헌과 로컬 확보 PDF가 다른 상태 | P02/P05 최종 검증 필요 |
