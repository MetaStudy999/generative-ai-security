...
| P02 | watermarking/fingerprinting 또는 LLM watermarking 보조 배경 | 현재 SUBSTITUTE PDF, 지정 원문 확보 필요 |
...
| P05 | GAN attack/defense 또는 privacy/security 보조 배경 | 지정 후보 DOI 확인, 로컬 SUBSTITUTE PDF |
