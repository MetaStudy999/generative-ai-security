...
W01-W15 final 보고서를 전체 배경으로 점검하고, W07, W08, W11, W14, W15 보고서를 중심축으로 삼아 LLM/RAG 보안 위협과 재현성 평가 항목을 통합한다. 주차별 논문 수식·알고리즘은 `formula_metric_supplement.md`에 별도 정리해 본문에서 필요한 지표만 선별해 사용한다.
...
| 분석 자료 | W01-W15 주차 final 보고서, 논문 비교표, 이론노트, AI 활용기록, 수식·지표 보충표 |
| 실험 데이터 | 공개 데이터 또는 synthetic context 기반 toy evaluation 설계 |
| 평가 지표 | Utility, Attack Success Rate, Privacy Leakage, Robustness, Reproducibility, Cost, Auditability, Formula/metric interpretability |
...
8. 수식·지표 보충표를 기준으로 핵심 지표의 기호, 쉬운 의미, 보안 평가 연결을 확인
