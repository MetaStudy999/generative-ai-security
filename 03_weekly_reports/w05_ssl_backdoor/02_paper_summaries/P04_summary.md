...
| 항목 | 내용 |
|---|---|
| 논문 제목 | Threats to Training: A Survey of Poisoning Attacks and Defenses on Machine Learning Systems |
| 저자 | Zhibo Wang et al. |
| 학술지/학회 | ACM Computing Surveys |
| 연도 | 2022 |
| DOI/URL | `10.1145/3538707`, https://doi.org/10.1145/3538707 |
| PDF 파일명 | 04_Wang_et_al_2022_Threats_to_Training_Poisoning_Survey.pdf |
| 검증 상태 | PDF 첫 페이지 DOI 링크 확인 |
...
P04는 자기지도학습/파운데이션 모델 및 Poisoning/Backdoor 연구에서 개념 정의, 위협 분류, 평가 지표 후보를 정리하는 근거로 반영한다. 특히 공격-방어-평가 관점을 연결하는 보안 분석 틀을 관련연구와 연구방법 장에 연결한다.
