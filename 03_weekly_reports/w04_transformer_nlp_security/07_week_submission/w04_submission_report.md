...
Codex와 ChatGPT 등 AI 도구를 사용해 논문 요약 보강, DOI/URL 검증 보조, 개념 설명, 문장 구조화, synthetic prompt 실험 코드 작성, 발표자료 작성, KCI/SCI 섹션 보완을 수행했다. AI 산출물은 초안으로만 사용했으며 최종 책임은 제출자가 확인해야 한다.
