...
| 실험 결과 | CSV/JSON/run log | `04_experiment/outputs/` |
| 통합보고서 | 최종본과 초안 | `06_report/` |
| 제출자료 | Markdown/HTML 제출본 | `07_week_submission/` |
| 발표자료 | 발표보고서, 슬라이드, 대본, Q&A, handout | `09_presentation/` |

## 검토 메모

정량값은 AI가 임의 생성한 값이 아니라 로컬 실행 결과다. 모든 수치 표현은 `outputs/run_log.md`와 맞춰야 한다.
