...
| 연도 | 2021/2023 |
| DOI/URL | arXiv: `https://arxiv.org/abs/2106.08962` |
| PDF 파일명 | `02_Menghani_2023_Efficient_Deep_Learning_Survey.pdf` |
| 검증 상태 | 로컬 PDF 메타데이터와 arXiv 제목/저자 대조, ACM DOI는 최종 확인 대상 |

## 2. 한 문장 요약

> 이 논문은 딥러닝 모델을 작고 빠르고 효율적으로 만들기 위한 압축, 아키텍처, 학습, 시스템, 하드웨어 기법을 정리하며, 정확도-비용-속도 trade-off를 보안 평가와 함께 기록해야 함을 시사한다.
