...
| 핵심 주장 | 운영형 AI 시스템 보안은 model accuracy만이 아니라 data/model/config/log/artifact traceability를 요구한다. |
| 실험 상태 | 실행 완료 |
...
- AI 원리 70%와 보안 이슈 30%를 실험 지표로 연결
- Research Track 연구문제, 위협모형, 평가방법, 한계
- W14 제출본과 발표자료 연결
