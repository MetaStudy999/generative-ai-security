...
![W05 metrics chart](assets/charts/w05_metrics_chart.png)
...
이 다이어그램은 `SSL backdoor evaluation flow`를 발표용으로 요약한 개념도다. 데이터 흐름, 평가 지표, 한계 표시는 `assets/figure_manifest.md`에도 기록했다.
