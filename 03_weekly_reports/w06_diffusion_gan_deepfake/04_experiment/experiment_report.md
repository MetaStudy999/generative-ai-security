...
W06 실습은 diffusion/GAN 기반 합성미디어와 딥페이크 탐지의 신뢰성 평가축을 안전한 toy 환경에서 확인하는 것이다. 실제 딥페이크 생성, 실제 개인정보 사용, 실제 서비스 질의는 제외하고 synthetic real/fake detector score 분포 기반 안전 toy 실험만 수행했다.
