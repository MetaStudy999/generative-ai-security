...
| 항목 | 내용 |
|---|---|
| 논문 제목 | A Systematic Survey on MLOps and AIOps: Taxonomy, Challenges, and Future Directions |
| 저자 | Daniel Diaz-de-Arcaya et al. |
| 학술지/학회 | ACM Computing Surveys |
| 연도 | 2023 |
| DOI/URL | 확인 필요 |
| PDF 파일명 | 03_SUBSTITUTE_Cheng_et_al_2023_AIOps_Cloud_Survey.pdf |
...
P03는 MLOps/DevOps/데이터/모델 파이프라인/공급망 보안 연구에서 개념 정의, 위협 분류, 평가 지표 후보를 정리하는 근거로 반영한다. 특히 기말 연구의 배경 이론과 평가축을 관련연구와 연구방법 장에 연결한다.
