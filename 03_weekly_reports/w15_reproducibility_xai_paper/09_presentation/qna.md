...
| 왜 P03은 미검증으로 남겼나요? | 프롬프트의 지정 논문은 Dwivedi et al.의 ACM CSUR 논문이지만 로컬 PDF는 Mersha et al.의 arXiv 대체 survey입니다. 최종 인용 전 지정 논문 원문을 확보해야 합니다. | `01_papers/doi_check.md`, `02_paper_summaries/P03_summary.md` |
| P05는 왜 부분 확인인가요? | 로컬 PDF에서 arXiv:2312.12936은 확인했지만, 파일명에 적힌 2025 출판 정보와 최종 DOI는 아직 확인하지 못했습니다. | `01_papers/doi_check.md` |
...
| 최종 제출 전에 남은 일은 무엇인가요? | P03 원문 확보, P05 최종 DOI 확인, 국내 문헌 3편 이상 검증, 기말논문 표/그림 실제 삽입입니다. | `03_theory_notes/open_problems.md` |
